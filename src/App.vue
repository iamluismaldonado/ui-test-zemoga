...
<template>
        ...
        <div class="featured-card__content">
          ...
          <p class="featured-card__more-info">
            <a href="http://wikipedia.com">
              <svg class="featured-card__more-info-icon" preserveAspectRatio xmlns="http://www.w3.org/2000/svg"
                   viewBox="0 0 27 18">
  ...
  <div class="max-centered">
    ...
    <aside class="banner banner-bottom" role="doc-tip" aria-label="Submit a name">
      <img srcset="src/assets/img/bg-people.png 750w, src/assets/img/bg-people.@2x.png 1440w"
           sizes="(min-width: 750px) 1440px, 100vw" class="banner__background" src="src/assets/img/bg-people.png" alt=""
           role="none">
      <div class="banner__left">
        <h2 class="banner__heading">Is there anyone else you would want us to
          add?</h2>
      </div>
      <div class="banner__right">
